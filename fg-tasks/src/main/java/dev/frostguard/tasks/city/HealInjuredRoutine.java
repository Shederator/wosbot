...
public class HealInjuredRoutine extends DelayedTask {
    ...
    private static final TesseractSettingsData WHITE_TEXT_SETTINGS = TesseractSettingsData.assembler()
    ...
    private static final TesseractSettingsData INJURED_COUNT_SETTINGS = TesseractSettingsData.assembler()
            .stripBackground(true)
            .setTextColor(new Color(255, 255, 255))
    ...
    private static final TesseractSettingsData TIMER_SETTINGS = TesseractSettingsData.assembler()
            .stripBackground(true)
            .setTextColor(new Color(255, 255, 255))
            .charWhitelist("0123456789:")
            .pageAnalysis(TesseractSettingsData.PageAnalysis.SINGLE_LINE)
