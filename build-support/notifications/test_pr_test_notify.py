#!/usr/bin/env python3
"""Unit tests for build-support/notifications/pr_test_notify.py."""
    ...
    def plan(self) -> dict:
        return sample_plan(
            ...
            merge={"ok": False, "tree_sha": "", "conflicts": [{
                "pr": 49,
                "files": [
                    {"path": "modules/automation/src/main/java/Foo.java", "binary": False},
                    {"path": "modules/vision/native/opencv.dll", "binary": True},
                ],
            }]},
