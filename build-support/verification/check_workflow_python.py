...
Usage:
    python3 build-support/verification/check_workflow_python.py [workflow_or_directory ...]

With no arguments it checks the canonical files under `.github/workflows`.
"""
