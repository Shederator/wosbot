...
``frostguard-<version>.jar``, so a runtime JAR that is referenced but missing
...
REQUIRED_PATTERNS = [
    (r"^frostguard-[^/]+\.jar$", "packaged desktop application JAR"),
    (r"^fg-watcher-[^/]+\.jar$", "shaded Telegram watcher JAR"),
    (r"^lib/opencv-[^/]+\.jar$", "OpenCV Java bindings"),
    (r"^lib/tess4j-[^/]+\.jar$", "tess4j OCR bindings"),
    (r"^lib/fg-vision-[^/]+\.jar$", "Frostguard vision module"),
