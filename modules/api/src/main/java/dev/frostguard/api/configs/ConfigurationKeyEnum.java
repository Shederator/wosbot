...
public enum ConfigurationKeyEnum {
    ...
    FISHING_MAX_CASTS_INT                       ("10",      Integer.class,       ConfigCategory.EVENTS),
    FISHING_TARGET_CATCHES_INT                  ("20",      Integer.class,       ConfigCategory.EVENTS),
    FISHING_MAX_RESTARTS_INT                    ("2",       Integer.class,       ConfigCategory.EVENTS),
    FISHING_SHORT_HAUL_RESTART_ENABLED_BOOL     ("true",    Boolean.class,       ConfigCategory.EVENTS),
    FISHING_DARK_CORNER_ENABLED_BOOL            ("true",    Boolean.class,       ConfigCategory.EVENTS),
    FISHING_MAX_SPECIAL_CASTS_INT               ("0",       Integer.class,       ConfigCategory.EVENTS),
    FISHING_USE_LANTERN_BOOL                    ("false",   Boolean.class,       ConfigCategory.EVENTS),
    FISHING_USE_STABILIZER_BOOL                 ("false",   Boolean.class,       ConfigCategory.EVENTS),
    FISHING_REQUIRE_SPECIAL_ITEMS_BOOL          ("false",   Boolean.class,       ConfigCategory.EVENTS),
    ...
    SHOP_NAVIGATION_FIRST_SWIPE_FROM_Y_INT      ("1240", Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FIRST_SWIPE_TO_X_INT        ("350",  Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FIRST_SWIPE_TO_Y_INT        ("1240", Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FIRST_SWIPE_DURATION_MS_INT ("0",    Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FIRST_SWIPE_SETTLE_MS_INT   ("1500", Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FOLLOW_UP_SWIPE_FROM_X_INT      ("600",  Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FOLLOW_UP_SWIPE_FROM_Y_INT      ("1240", Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FOLLOW_UP_SWIPE_TO_X_INT        ("350",  Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FOLLOW_UP_SWIPE_TO_Y_INT        ("1240", Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FOLLOW_UP_SWIPE_DURATION_MS_INT ("0",    Integer.class, ConfigCategory.SYSTEM),
    SHOP_NAVIGATION_FOLLOW_UP_SWIPE_SETTLE_MS_INT   ("1500", Integer.class, ConfigCategory.SYSTEM),
