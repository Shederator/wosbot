...
public enum TemplatesEnum {
    ...
    GAME_HOME_RECONNECT, QUIT_GAME_DIALOG, GAME_START_DOWNLOAD_NOW, GAME_HOME_NEW_SURVIVORS, GAME_HOME_NEW_SURVIVORS_WELCOME_IN, GAME_HOME_NEW_SURVIVORS_PLUS_BUTTON, GAME_HOME_BOTTOM_BAR_SHOP_BUTTON,
    ...
    PETS_CHEST_COMPLETED, PETS_CHEST_SELECT, PETS_PET_LIST_HEADER, PETS_CHEST_START, PETS_CHEST_ATTEMPT,
    PETS_CHEST_SHARE, PETS_CHEST_RED, PETS_CHEST_PURPLE, PETS_CHEST_BLUE, LIFE_ESSENCE_MENU,
    LIFE_ESSENCE_CLAIM, LIFE_ESSENCE_CLAIM_CURRENT, LIFE_ESSENCE_DAILY_CARING_AVAILABLE,
    LIFE_ESSENCE_DAILY_CARING_GOTO_ISLAND, LIFE_ESSENCE_DAILY_CARING_BUTTON,
    LIFE_ESSENCE_DAILY_CARING_BUTTON_CURRENT, ISLAND_WEEKLY_FREE_SCROLL, ISLAND_WEEKLY_FREE_SCROLL_BUY_BUTTON,
    ISLAND_LIKE_BUTTON,
    ...
    EXPLORATION_CLAIM, EXPLORATION_CLAIM_DISABLED, EXPLORATION_BUTTON, EXPLORATION_VICTORY, EXPLORATION_DEFEAT,
    MONUMENT_REWARD_BADGE, MONUMENT_REWARD_BADGE_SCROLL, MONUMENT_ATLAS_CLAIM_BUTTON, MONUMENT_ATLAS_CLAIM_ALL_BUTTON, MONUMENT_PUZZLE_READY_ICON, MONUMENT_LANCER_CAMP_ANCHOR, MONUMENT_BUILDING_ANCHOR, MONUMENT_MY_CITY_ANCHOR, MONUMENT_TUNDRA_ALBUMS_OPTION, MONUMENT_PUZZLE_OVERVIEW_FRAGMENT_BACKPACK_ICON,
    EVENTS_CLAIM_BUTTON, EVENTS_TAB_HALL_OF_CHIEFS, EVENTS_TAB_DEFEAT_BEASTS, EVENTS_TAB_BROTHERS_IN_ARMS,
    EVENTS_TAB_HERO_RALLY, EVENTS_HERO_RALLY_CLAIM_ALL, EVENTS_TAB_LUCKY_WHEEL, EVENTS_LUCKY_CHIP_FREE_BUTTON, HERO_RECRUIT_CLAIM,
    HOME_SHOP_CART_BUTTON, SHOP_CUSTOM_ARMAMENT_CHEST_CLAIMABLE, SHOP_TAB_DAILY_DEALS, SHOP_DAILY_DEALS_FREE_CHEST,
