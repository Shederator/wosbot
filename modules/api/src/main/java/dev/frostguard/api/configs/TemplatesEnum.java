...
public enum TemplatesEnum {
    ...
    MONUMENT_REWARD_BADGE, MONUMENT_ATLAS_CLAIM_BUTTON, MONUMENT_LANCER_CAMP_ANCHOR, MONUMENT_BUILDING_ANCHOR, MONUMENT_MY_CITY_ANCHOR, MONUMENT_TUNDRA_ALBUMS_OPTION,
