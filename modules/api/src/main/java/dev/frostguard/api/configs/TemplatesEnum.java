...
public enum TemplatesEnum {
    ...
    SIDEBAR_DAILY_CRYSTAL_LABORATORY,
    SIDEBAR_DAILY_LIFE_ESSENCE, SIDEBAR_GO_ACTION, SIDEBAR_GO_ACTION_NOTIFICATION,
    SIDEBAR_CLAIM_ACTION, SIDEBAR_DAILY_LIGHTHOUSE_INTEL, LIGHTHOUSE_INTEL_BUBBLE,
    ...
    AM_TRAIN_TROOPS, AM_TRAINING_SPEEDUPS, AM_USE_GEMS, AM_USE_SPEEDUPS,
    CRYSTAL_LAB_BUILDING_MARKER, CRYSTAL_LAB_FC_BUTTON,
    ...
    // Destination-state landmarks. ResourceStockpileRoutine reaches Overview, Backpack, Summary
    // and Speedup by fixed 720x1280 taps; matching one of these proves the tap actually landed
    // on the intended screen, so a mistap cannot seed the cache from the wrong panel.
    RESOURCE_STOCKPILE_OVERVIEW_PANEL_TITLE, RESOURCE_STOCKPILE_BACKPACK_SCREEN_TITLE,
    RESOURCE_STOCKPILE_SUMMARY_POPUP_TITLE, RESOURCE_STOCKPILE_SPEEDUP_TAB_HEADER;
